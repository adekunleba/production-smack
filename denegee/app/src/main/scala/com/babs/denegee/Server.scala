...
object Server extends Web with App {
  ...
  implicit protected[this] val materializer: ActorMaterializer    = ActorMaterializer()
  implicit protected[this] val executionContext: ExecutionContext = actorSystem.dispatcher
