...
lazy val restartSettings = Seq(javaOptions in reStart += jvmMaxMemoryFlag)
...
lazy val root = Project(id = "hydra", base = file("."))
...
// To start understanding the project, understand core. Cos it is a standealone
...
lazy val kafka = Project(id = "kafka", base = file("ingestors/kafka"))
  .dependsOn(core)
...
lazy val avro = Project(id = "avro", base = file("avro"))
  .dependsOn(common)
  .settings(
    moduleSettings,
    name := "hydra-avro",
